package id.co.pelitabangsa.myapplication;
...
import id.co.pelitabangsa.myapplication.adapter.ListAdapterHandphone;
import id.co.pelitabangsa.myapplication.model.Handphone;
import id.co.pelitabangsa.myapplication.server.AsyncInvokeURLTask;
...
public class MainActivity extends ActionBarActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ComponentName getCompon;
        searchView.setSearchableInfo(searchManager.getSearchableInfo(getCompon entName()));
    ...
    private Object getSystemService(String searchService) {
    }
    ...
    private void populateListView() {
        ...
        listView.setOnItemLongClickListener(new
                                                    AdapterView.OnItemLongClickListener()
                                                    {
                                                        ...
                                                        private ActionMode startActionMode(ActionMode.Callback amCallback) {
                                                        }
                                                    });
